...
export TESTDIR=test6_scenario_nocosts
...
export TWIN_NAME="test-pipeline.test6-twin"
export SIM_NAME="test-pipeline.test6-sim"
...
echo "plantd:twinmodel:test-pipeline.test6-twin:" `redis-cli get plantd:twinmodel:test-pipeline.test6-twin | wc -l`
echo "plantd:simulation_traffic:test-pipeline.test6-sim:" `redis-cli get plantd:simulation_traffic:test-pipeline.test6-sim | wc -l`
echo "plantd:simulation_summary:test-pipeline.test6-sim:" `redis-cli get plantd:simulation_summary:test-pipeline.test6-sim | wc -l`
echo "plantd:simulation_monthly:test-pipeline.test6-sim:" `redis-cli get plantd:simulation_monthly:test-pipeline.test6-sim | wc -l`
