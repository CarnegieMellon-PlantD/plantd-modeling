...
# SIM2: No scenario, just quickscale model built from experiment, and netcost info
export SCENARIO_NAME=
export NETCOSTS="`cat test2_quickscale/test-pipeline.sample-netcost.json`"
export MODEL_TYPE="quickscaling"
#export FROM_CACHED="from_cached"
export FROM_CACHED=
export DATASET_METADATA="`cat test2_quickscale/dataset.json`"
export EXPERIMENT_NAMES=test-pipeline.sample-experiment
export EXPERIMENT_METADATA="`cat test2_quickscale/experiment.json`"
export LOAD_PATTERN_NAMES=test-pipeline.test-loadpattern
export LOAD_PATTERN_METADATA="`cat test2_quickscale/loadpattern.json`"
source test2_quickscale/traffic-model-nominal.env
...
redis-cli del plantd:netcost_predictions:test-pipeline.test-sim
...
echo "plantd:netcost_predictions:test-pipeline.test-sim:" `redis-cli get plantd:netcost_predictions:test-pipeline.test-sim | wc -l`
...
#   plantd:netcost_predictions:test-pipeline.test-sim
#       - netcost predictions for the simulation
