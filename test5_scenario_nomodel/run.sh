...
echo "plantd:twinmodel:test-pipeline.test5-twin:" `redis-cli get plantd:twinmodel:test-pipeline.test5-twin | wc -l`
echo "plantd:simulation_traffic:test-pipeline.test5-sim:" `redis-cli get plantd:simulation_traffic:test-pipeline.test5-sim | wc -l`
echo "plantd:simulation_summary:test-pipeline.test5-sim:" `redis-cli get plantd:simulation_summary:test-pipeline.test5-sim | wc -l`
echo "plantd:simulation_monthly:test-pipeline.test5-sim:" `redis-cli get plantd:simulation_monthly:test-pipeline.test5-sim | wc -l`
